...
| `icon` | <class 'str'> | Required | Parameter description |
| `command` | typing.Optional[typing.Callable] | None | Parameter description |
| `tooltip` | typing.Optional[str] | None | Parameter description |
| `size` | <class 'str'> | medium | Parameter description |
| `shape` | <class 'str'> | square | Parameter description |
...
```python
from ui.input_components import IconButton

# Basic usage
component = IconButton(parent)
component.pack()
...
- [Examples](../examples/iconbutton.py)
