...
| `title` | <class 'str'> | Confirm | Parameter description |
| `message` | <class 'str'> | Are you sure? | Parameter description |
| `confirm_button` | <class 'str'> | Yes | Parameter description |
| `cancel_button` | <class 'str'> | No | Parameter description |
...
### get_confirmation_result(self) -> bool
...
```python
from ui.dialog_components import ConfirmationDialog

# Basic usage
component = ConfirmationDialog(parent)
component.pack()
...
- [Examples](../examples/confirmationdialog.py)
