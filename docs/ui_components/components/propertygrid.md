...
| `properties` | typing.Dict[str, typing.Any] | None | Parameter description |
| `categories` | typing.Dict[str, typing.List[str]] | None | Parameter description |
| `property_types` | typing.Dict[str, str] | None | Parameter description |
| `readonly_properties` | typing.List[str] | None | Parameter description |
...
### add_property(self, prop_name: str, value: Any, category: str = None, prop_type: str = None)
Add a new property.
...
### get_property(self, prop_name: str) -> Any
...
### remove_property(self, prop_name: str)
Remove a property.

### set_enabled(self, enabled: bool)
Enable or disable the component.

### set_properties(self, properties: Dict[str, Any])
Update all properties.

### set_property(self, prop_name: str, value: Any)
...
```python
from ui.specialized_display_components import PropertyGrid

# Basic usage
component = PropertyGrid(parent)
component.pack()
...
- [Examples](../examples/propertygrid.py)
