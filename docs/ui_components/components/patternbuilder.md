...
| `on_pattern_change` | typing.Optional[typing.Callable] | None | Parameter description |
...
### set_pattern_data(self, pattern_data: Dict)
...
```python
from ui.pattern_management_components import PatternBuilder

# Basic usage
component = PatternBuilder(parent)
component.pack()
...
- [Examples](../examples/patternbuilder.py)
