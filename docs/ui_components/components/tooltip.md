...
| `delay` | <class 'int'> | 500 | Parameter description |
| `position` | <class 'str'> | auto | Parameter description |
| `rich_content` | <class 'bool'> | False | Parameter description |
...
### attach_to(self, widget: tkinter.Widget)
...
```python
from ui.display_components import Tooltip
