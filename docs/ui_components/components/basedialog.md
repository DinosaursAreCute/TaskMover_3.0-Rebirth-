...
| `title` | <class 'str'> | Dialog | Parameter description |
| `modal` | <class 'bool'> | True | Parameter description |
| `resizable` | <class 'bool'> | False | Parameter description |
| `size` | <class 'tuple'> | (400, 300) | Parameter description |
...
```python
from ui.dialog_components import BaseDialog

# Basic usage
component = BaseDialog(parent)
component.pack()
...
- [Examples](../examples/basedialog.py)
