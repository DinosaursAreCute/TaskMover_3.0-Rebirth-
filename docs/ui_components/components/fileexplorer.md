...
| `root_directory` | typing.Optional[str] | None | Parameter description |
| `on_file_select` | typing.Optional[typing.Callable] | None | Parameter description |
| `on_directory_change` | typing.Optional[typing.Callable] | None | Parameter description |
...
### get_selected_files(self) -> List[str]
...
### set_directory(self, directory: str)
...
```python
from ui.file_organization_components import FileExplorer

# Basic usage
component = FileExplorer(parent)
component.pack()
...
- [Examples](../examples/fileexplorer.py)
