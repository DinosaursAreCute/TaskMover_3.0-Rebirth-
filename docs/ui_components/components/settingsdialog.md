...
| `settings` | typing.Optional[typing.Dict[str, typing.Any]] | None | Parameter description |
| `categories` | typing.Optional[typing.Dict[str, typing.List[str]]] | None | Parameter description |
...
```python
from ui.dialog_components import SettingsDialog

# Basic usage
component = SettingsDialog(parent)
component.pack()
...
- [Examples](../examples/settingsdialog.py)
