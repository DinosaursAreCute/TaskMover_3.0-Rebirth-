...
| `path` | typing.List[typing.Dict] | None | Parameter description |
| `separator` | <class 'str'> |  >  | Parameter description |
| `max_items` | <class 'int'> | 5 | Parameter description |
| `show_home` | <class 'bool'> | True | Parameter description |
...
### pop_to_item(self, item_id: str)
Remove all items after the specified item.

### set_enabled(self, enabled: bool)
Enable or disable the component.

### set_path(self, path: List[Dict])
...
```python
from ui.navigation_components import Breadcrumb

# Basic usage
component = Breadcrumb(parent)
component.pack()
...
- [Examples](../examples/breadcrumb.py)
