...
| `rulesets` | typing.Optional[typing.List[typing.Dict]] | None | Parameter description |
| `on_ruleset_select` | typing.Optional[typing.Callable] | None | Parameter description |
| `on_ruleset_action` | typing.Optional[typing.Callable] | None | Parameter description |
...
### update_rulesets(self, rulesets: List[Dict])
...
```python
from ui.ruleset_management_components import RulesetOverview

# Basic usage
component = RulesetOverview(parent)
component.pack()
...
- [Examples](../examples/rulesetoverview.py)
