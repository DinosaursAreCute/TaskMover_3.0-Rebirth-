...
| `title` | <class 'str'> | Input | Parameter description |
| `prompt` | <class 'str'> | Enter value: | Parameter description |
| `default_value` | <class 'str'> |  | Parameter description |
| `input_type` | <class 'str'> | text | Parameter description |
| `validation_func` | typing.Optional[typing.Callable] | None | Parameter description |
...
```python
from ui.dialog_components import InputDialog

# Basic usage
component = InputDialog(parent)
component.pack()
...
- [Examples](../examples/inputdialog.py)
