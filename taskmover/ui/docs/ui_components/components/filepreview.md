...
| `file_path` | typing.Optional[str] | None | Parameter description |
| `show_metadata` | <class 'bool'> | True | Parameter description |
| `max_text_size` | <class 'int'> | 1048576 | Parameter description |
...
```python
from ui.specialized_display_components import FilePreview

# Basic usage
component = FilePreview(parent)
component.pack()
...
- [Examples](../examples/filepreview.py)
