...
| `execution_data` | typing.Optional[typing.Dict] | None | Parameter description |
| `on_execution_control` | typing.Optional[typing.Callable] | None | Parameter description |
...
### add_log_entry(self, message: str, level: str = 'info')
...
### update_execution_data(self, data: Dict)
...
```python
from ui.ruleset_management_components import RulesetExecutionDashboard

# Basic usage
component = RulesetExecutionDashboard(parent)
component.pack()
...
- [Examples](../examples/rulesetexecutiondashboard.py)
