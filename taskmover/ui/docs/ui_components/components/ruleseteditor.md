...
| `ruleset_data` | typing.Optional[typing.Dict] | None | Parameter description |
| `available_rules` | typing.Optional[typing.List[typing.Dict]] | None | Parameter description |
| `on_ruleset_save` | typing.Optional[typing.Callable] | None | Parameter description |
...
```python
from ui.ruleset_management_components import RulesetEditor

# Basic usage
component = RulesetEditor(parent)
component.pack()
...
- [Examples](../examples/ruleseteditor.py)
