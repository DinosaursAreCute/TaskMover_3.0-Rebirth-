...
| `on_organize` | typing.Optional[typing.Callable] | None | Parameter description |
| `on_preview` | typing.Optional[typing.Callable] | None | Parameter description |
...
### set_source_directory(self, directory: str)
...
```python
from ui.file_organization_components import OrganizationDashboard

# Basic usage
component = OrganizationDashboard(parent)
component.pack()
...
- [Examples](../examples/organizationdashboard.py)
