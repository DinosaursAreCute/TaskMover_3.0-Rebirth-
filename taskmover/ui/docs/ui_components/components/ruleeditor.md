...
| `rule_data` | typing.Optional[typing.Dict] | None | Parameter description |
| `available_patterns` | typing.Optional[typing.List[typing.Dict]] | None | Parameter description |
| `on_rule_change` | typing.Optional[typing.Callable] | None | Parameter description |
...
### set_rule_data(self, rule_data: Dict)
Set the rule data.
...
```python
from ui.rule_management_components import RuleEditor

# Basic usage
component = RuleEditor(parent)
component.pack()
...
- [Examples](../examples/ruleeditor.py)
